...
(UEA) Se um corpo de capacidade térmica igual a \Sexpr{capac} cal/°C recebe calor de uma fonte durante 20 minutos com taxa constante de \Sexpr{c_recebido} cal/min, determine a varia\c{c}\~ao de temperatura sofrida por ele. \textit{Arredonde para 1 casa decimal.}
