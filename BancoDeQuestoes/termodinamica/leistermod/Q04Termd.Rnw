...
plot(x, y, type="o", pch=20, col="black", ylab=expression(paste("Pressão (10³", " Pa)")), ylim=range(0, Pmax), yaxp=c(0,Pmax,4), xlim=range(0, xpasso), xlab=expression(paste("Volume (", 10^-4, "m³)")), xaxp=c(0,xpasso,5))
