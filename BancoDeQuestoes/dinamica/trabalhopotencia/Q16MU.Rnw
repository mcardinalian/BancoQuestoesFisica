...
(Uel) O gráfico representa o valor algébrico da força resultante F que age sobre um corpo de massa 5,0kg, inicialmente em repouso, em função da abscissa x.
